...
export default function Contact() {
  ...
  const staffEmail = 'juanmibro55@gmail.com'

  function sendContactEmail() {
    const templateId = 'template_elozfhu'
    const serviceId = 'service_beowxyr'
    const publicKey = 'Kcc3NYDpXQNi9jixp'
    // const userId = 'user_1q8q9qo'
  ...
  return (
    <div className="isolate bg-gray-100 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <form
        action="https://formsubmit.co/el/cezama"
        method="POST"
      ...
      >
        ...
        <div className="mt-10">
          <button
            ...
            className="block w-full cursor-pointer rounded-md py-2 bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Let's talk
          </button>
        </div>
